        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex flex-col gap-2">
              <span className="text-xs text-slate-500">{t('register.avatar.choose')}</span>
                ...
                {PRESET_AVATARS.map((pic, idx) => (
                  <button
                    ...
                    className={`relative rounded-full overflow-hidden w-10 h-10 border-2 transition-all cursor-pointer ${
                      avatar === pic && !customAvatar ? 'border-emerald-500 scale-110 shadow-md' : 'border-slate-600 opacity-70 hover:opacity-100'
                    }`}
                  >
              ...
              <div className="mt-1">
                <span className="text-xs text-slate-500">{t('register.avatar.custom')}</span>
                <input
                  type="url"
                  placeholder="https://exemplo.com/sua-foto.jpg"
                  value={customAvatar}
                  onChange={(e) => setCustomAvatar(e.target.value)}
                  className="w-full text-xs border border-slate-600 rounded-lg p-2 focus:ring-1 focus:ring-emerald-400 outline-none mt-1"
                />
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-4 py-2.5 text-xs text-slate-200 border border-slate-600 rounded-xl focus:ring-2 focus:ring-emerald-400/20 focus:border-emerald-400 outline-none font-bold"
              />
            </div>
          </div>
